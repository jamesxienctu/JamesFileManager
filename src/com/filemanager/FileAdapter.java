...
public class FileAdapter extends BaseAdapter{
	...
	protected JamesFileManager fileManager;
	...
	public FileAdapter(JamesFileManager context, FileData info, int style) {
		fileManager = (JamesFileManager)context;
		fData = info;
		if (fData == null)
			fData = new FileData(new ArrayList<FileInfo>(),
					null, JamesFileManager.SDCARD_PATH);
