...
public class TextGalleryAdapter extends BaseAdapter{
	...
	public TextGalleryAdapter(Context ct, String path){
		...
		TEXT_HEIGHT = (int)(20*PIX_SCALE+0.5f);
		TEXT_MAX_WIDTH = (int)(90*PIX_SCALE+0.5f);
		TEXT_SIZE = (int)(2*PIX_SCALE+9f);	//Modified by James.修正[app畫面]->[檔案路徑]的字體太大問題
		TEXT_WIDTH  = (int)(8*PIX_SCALE+11f); //For cell phone.
		//TEXT_WIDTH  = (int)(8*PIX_SCALE+5f); //For pad.
		refreshPath(path);
	}
