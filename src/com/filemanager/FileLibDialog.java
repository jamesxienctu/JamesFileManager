...
import com.android.utils.XDialog.InputClick;
...
public class FileLibDialog extends Dialog implements DialogInterface{
	 ...
	 * parentList 放 文件庫名.
	 * childList 放對應檔庫裡的檔.
	 * 庫名在parentList的位置與其檔在childList的位置一樣
	 * */
	...
	public FileLibDialog(final JamesFileManager fm, ArrayList<String> parent,
		...
		lists.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view,
				...
				if (id < 0) {
					...
					cs = new CharSequence[] {"從庫中刪除", "打開檔目錄"};
					...
					// 點擊組
					AlertDialog.Builder b = new AlertDialog.Builder(fm);
					b.setItems(new CharSequence[]{"刪除", "重命名"},
							new OnClickListener() {
								...
								public void onClick(DialogInterface dialog, int which) {
									...
									switch (which) {
										case 0:
											...
											b.setTitle("刪除檔庫").setMessage("確定要刪除 " + libName + " ?")
										...
										case 1:
											...
											XDialog.inputDialog(fm, "重命名庫" + libName,
													"新庫名", libName, null,
		...
		addBtn.setOnClickListener(new Button.OnClickListener() {
			...
			public void onClick(View v) {
				...
				XDialog.inputDialog(fm, "添加文件庫", "文件庫名",
